                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                            <h4 class="mb-sm-0 text-primary text-capitalize">All Category List</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-primary" href="{{ route('catagories.create') }}" role="button"><b>+ Add Category</b></a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    &nbsp;
                                                    {{-- Edit --}}
                                                    <a href="{{ route('catagories.edit', $value->id) }}">
                                                    ...
                                                    &nbsp;
                                                    {{-- Delete --}}
                                                    <form action="{{ route('catagories.destroy', $value->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
