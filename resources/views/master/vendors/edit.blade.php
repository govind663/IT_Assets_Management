                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                            <h4 class="mb-sm-0 text-primary text-capitalize">Edit Vendors</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="company_name" name="company_name" class="form-control @error('company_name') is-invalid @enderror" value="{{ $vendors->company_name }}" placeholder="Enter Company Name" >
                                        @error('company_name')
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" id="company_add" name="company_add" class="form-control @error('company_add') is-invalid @enderror" value="{{ $vendors->company_add }}" placeholder="Enter Company Address" >{{ $vendors->company_add }}</textarea>
                                        @error('company_add')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="company_phone_no"  name="company_phone_no" class="form-control @error('company_phone_no') is-invalid @enderror" value="{{ $vendors->company_phone_no }}" placeholder="Enter Company Mobile No" >
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $vendors->email }}" placeholder="Enter Email Id" >
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="gst_no" name="gst_no" class="form-control @error('gst_no') is-invalid @enderror" value="{{ $vendors->gst_no }}" placeholder="Enter GST Number" >
                                        @error('gst_no')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
