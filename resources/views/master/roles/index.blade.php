                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                            <h4 class="mb-sm-0 text-primary text-capitalize">All Roles List</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-primary" href="{{ route('roles.create') }}" role="button"><b>+ Add Roles</b></a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="buttons-datatables" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    {{-- Read --}}
                                                    <a href="{{ route('roles.show', $value->id) }}">
