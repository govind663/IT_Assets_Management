                ...
                <div class="row gy-3">
                    <div class="col-4">
                        <div class="form-check card-radio">
                            <input id="customizer-layout01" name="data-layout" type="radio" value="horizontal"
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch p-2 px-3 bg-light rounded">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <span class="avatar-title rounded-circle bg-horizontal-gradient"></span>
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar"
                                ...
                                <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <span class="avatar-title rounded-circle bg-horizontal-gradient-2"></span>
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar"
                                ...
                                <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <span class="avatar-title rounded-circle bg-horizontal-gradient-3"></span>
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar"
                                ...
                                <label class="form-check-label p-0 avatar-xs rounded-circle"
                                    ...
                                    <span class="avatar-title rounded-circle bg-horizontal-gradient-4"></span>
                                </label>
                            </div>
                        </div>
                    </div>
