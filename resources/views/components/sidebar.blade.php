...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('dashboard') }}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ url('/') }}/assets/images/panvel_img/pmc-logo-dark" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{ url('/') }}/assets/images/panvel_img/pmc-logo-dark" alt="" height="17">
            </span>
        </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="layouts-horizontal-hovered.html" target="_blank" class="nav-link"
