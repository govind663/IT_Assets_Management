...
@section('title')
Request For Return Material | List
@endsection
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Request For Return Material</a></li>
                                    ...
                                    <table id="buttons-datatables" class="table table-bordered dt-responsive table-nowrap table-striped align-middle" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @elseif($value->status == 2 && $value->is_processed_by_it == 2)
                                                <td>{{ $value->rejection_reason_by_it }}</td>
                                                <td>{{ date("d-m-Y", strtotime($value->sent_to_it_at)) }}</td>
                                                @endif

                                                <td>
                                                    {{-- Read --}}
                                                    <a href="{{ route('replace-old-material.view', [ 'id'=>$value->id, 'status'=>$value->status ] ) }}">
