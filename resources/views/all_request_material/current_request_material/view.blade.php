    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('/', [ 'id'=>$materials['new_material']->id, 'status'=>$materials['new_material']->status ]) }}"  enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6 ">
                            <label for="receiverName" class="form-label"><b> Receiver  Name : </b></label>
                            <input type="text" class="form-control" readonly id="receiverName" name="receiverName" value="{{ Auth::user()->f_name }}{{ Auth::user()->m_name }}{{ Auth::user()->l_name }}" >
                        </div>
                        <div class="col-md-6">
                            <label for="receiverContactNo" class="form-label"><b>Contact  Number :</b></label>
                            <input type="text" class="form-control" readonly id="receiverContactNo" name="receiverContactNo" value="{{ Auth::user()->phone_number }}" >
                        </div>

                        <div class="col-md-6">
                            <label for="receiverDeptID" class="form-label"><b>Department :</b></label>
                            <div class="input-group">
                                <input type="text" class="form-control" readonly id="receiverDeptID" name="receiverDeptID" value="{{ $materials['new_material']->department?->dept_name }}">
                            </div>
                        </div>
                        ...
                        @endphp
                        <div class="col-md-6">
                            <label for="receiverSex" class="form-label"><b>Gender :</b></label>
                            <div class="input-group">
                                <input type="text" class="form-control" readonly id="receiverSex" name="receiverSex" value="{{ $authSex }}">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label for="receiverDesigination" class="form-label"><b>Desigination :</b></label>
                            <div class="input-group">
                                <input type="text" class="form-control" readonly id="receiverDesigination" name="receiverDesigination" value="{{ Auth::user()->role_id }}">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label for="receiverDate" class="form-label"><b>Receiver Date :</b></label>
                            <div class="input-group">
                                <input type="text" class="form-control" readonly id="receiverDate" name="receiverDate" value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="receiverTime" class="form-label"><b>Receiver Time  :</b></label>
                            <div class="input-group">
                                <input type="text" class="form-control" readonly id="receiverTime" name="receiverTime" value="{{ date('H:i:s') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
